...
import psutil
save_path = 'E:\\project.python\\test\\DLPFC-RESULT4'
...
for sample_name in sample_list:
    ...
    # dir_output = Path(f'{save_path}/{sample_name}/')
    ...
    # plt.savefig(os.path.join(save_path, f'{sample_name}.png'), dpi=600)
    # plt.close()
end_time = time.time()
memory_after = process.memory_info().rss
# print(f"运行时间: {end_time - start_time}秒")
# print(f"内存使用: {memory_after - memory_before}字节")
